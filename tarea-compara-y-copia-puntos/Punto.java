...
public class Punto {
    ...
    /** Compara si los valores de los atributos de este punto son iguales a los de otro punto */
    public boolean esIgual(Punto otroPunto) {
        return (otroPunto.getX() == this.getX())&&(otroPunto.getY() == this.getY());// Completa este método.
        
    }
    
    /** Hace que este punto tenga los mismos valores de atributos que otro punto */
    public void copiaDesde(Punto otroPunto) {
